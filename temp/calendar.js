(function () {
	...
	var dateCalcArray = [dateCalcWithLeap(5), dateCalcWithLeap(1), dateCalc(1), dateCalc(4), dateCalc(6), dateCalc(2), dateCalc(4), dateCalc(0), dateCalc(3), dateCalc(5), dateCalc(1), dateCalc(3)]; //This array runs the date calc function where n is the day of the week of the first of each month in 2010
	...
	function dateCalc(n) {
		//Calculates how many date boxes need to be added to beggining of month. March through December
	...
	function dateCalcWithLeap(n) {
		//Calculates how many date boxes need to be added to beggining of month. January and Feb.
